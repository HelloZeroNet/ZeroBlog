...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/lib/00-jquery.min.js ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/lib/highlight.pack.js ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/lib/identicon.js ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/lib/jquery.cssanim.coffee ---- */
...
(function() {
  jQuery.fn.cssSlideDown = function() {
    ...
    setTimeout((function() {
      ...
      console.log("slideDown", this, height);
      elem.css({
        "height": 0,
        "display": ""
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/lib/jquery.csslater.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/lib/marked.min.js ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/lib/pnglib.js ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/utils/Class.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/utils/InlineEditor.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/utils/RateLimit.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/utils/Text.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/utils/Time.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/utils/ZeroFrame.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/Comments.coffee ---- */
...
/* ---- data/1AQF2XPwKoZVmeDMWukC5dCAmCEiDztUNt/js/ZeroBlog.coffee ---- */
...
(function() {
  ...
  ZeroBlog = (function(_super) {
    ...
    ZeroBlog.prototype.loadLastcomments = function(type, cb) {
      ...
      query = "SELECT comment.*, json_content.json_id AS content_json_id, keyvalue.value AS cert_user_id, json.directory, post.title AS post_title FROM comment LEFT JOIN json USING (json_id) LEFT JOIN json AS json_content ON (json_content.directory = json.directory AND json_content.file_name='content.json') LEFT JOIN keyvalue ON (keyvalue.json_id = json_content.json_id AND key = 'cert_user_id') LEFT JOIN post ON (comment.post_id = post.post_id) ORDER BY date_added DESC LIMIT 3";
      return this.cmd("dbQuery", [query], (function(_this) {
        return function(res) {
